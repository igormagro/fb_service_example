...
class RouteLoggerMiddleware(BaseHTTPMiddleware):
    ...
    def _generate_success_log(
        ...
        return f"Request {overall_status}, {request.method} {request.url.path}, status code={response.status_code}, took={execution_time:0.4f}s, request_ip={request.client.host}"
